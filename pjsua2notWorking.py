    ...
    # === NEW, W# PASTE THIS NEW DIAGNOSTIC BLOCK INTO YOUR main.py
            ...
            if media_id:
                try:
                    ...
                    print("channel id 1 :",channel_id1)
...
def on_message(ws, message):
    ...
    if event_type == 'StasisStart':
        ...
        if 'connected' in channel_id and 'number' in channel_id['connected'] and channel_id['connected']['number']:
        ...
        if channel_id and final_filename:
            ...
            threading.Thread(target=interact_with_user, args=(channel_id, full_path)).start()
